...
def nova_tela():
    nova_janela = ctk.CTkToplevel(janela, fg_color="teal") #cria uma nova telA. para mudar a cor so dela fg_color
    nova_janela.title("Nova Tela")
    nova_janela.geometry("500x300")


bnt_nova_tela = ctk.CTkButton(master=janela, text="Nova Tela", command=nova_tela).place(x=300, y=100) #cria um botão que chama a função nova_tela
